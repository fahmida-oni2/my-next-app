...
export default function page() {
  return (
    <div className="flex flex-col min-h-screen">
      <h2 className="text-4xl mt-5 text-center text-black font-bold mb-4 animate__animated animate__fadeInDown">
        About Us
      </h2>
      <p className="text-gray-600 mb-12 text-center animate__animated animate__fadeInUp max-w-3xl mx-auto">
      ...
      {/* About */}
      <div className="flex flex-col lg:flex-row items-center bg-gray-50 p-6 rounded-xl   animate__animated animate__fadeInLeft">
      ...
      <div className="  flex-col lg:flex-row items-center bg-gray-50 p-6 rounded-xl   animate__animated animate__fadeInRight">
      ...
      {/* Vision */}
      <div className="flex flex-col-reverse lg:flex-row  items-center m-5">
        <Image
